...
<article>
	...
	<section>
		<h3>
			...
			<a
				target="_blank"
				href="https://signal.me/#eu/hXn-3GFm2_2D8BZhcAjrN0UKZ1_x4F_ldUruruFqmnuB5QNikbZB8rruU_oJ0Im4"
				class="button"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 160 160"
				...
				>
					<g fill="rgb(var(--text-color))">
						<path
							d="M80 0c4.15 0 8.227.316 12.207.925L91.063 8.34A73 73 0 0 0 80 7.5c-3.761 0-7.455.286-11.062.839L67.793.925A80.6 80.6 0 0 1 80 0M98.985 2.266l-1.78 7.288a72 72 0 0 1 20.439 8.473l3.895-6.411a79.5 79.5 0 0 0-22.554-9.35M127.279 15.46l-4.432 6.05a73 73 0 0 1 15.643 15.643l6.051-4.432a80.5 80.5 0 0 0-17.262-17.262M148.384 38.462l-6.411 3.894a72 72 0 0 1 8.473 20.44l7.288-1.78a79.5 79.5 0 0 0-9.35-22.554M159.075 67.793l-7.414 1.145c.553 3.607.839 7.3.839 11.062s-.286 7.456-.839 11.063l7.414 1.144A81 81 0 0 0 160 80c0-4.15-.316-8.227-.925-12.207M141.973 117.645a72 72 0 0 0 8.473-20.44l7.288 1.78a79.5 79.5 0 0 1-9.35 22.554zM138.49 122.847l6.051 4.432a80.5 80.5 0 0 1-17.262 17.262l-4.433-6.051a72.9 72.9 0 0 0 15.644-15.643M117.644 141.973l3.894 6.411a79.5 79.5 0 0 1-22.554 9.35l-1.78-7.288a72 72 0 0 0 20.44-8.473M91.062 151.661l1.145 7.414c-3.98.609-8.057.925-12.207.925s-8.227-.316-12.207-.925l1.144-7.413c3.605.552 7.3.838 11.063.838 3.761 0 7.456-.286 11.062-.839M62.795 150.448l-1.78 7.286a79.4 79.4 0 0 1-17.278-6.406l-7.593 1.772-1.704-7.304 10.26-2.394 2.44 1.243a72 72 0 0 0 15.654 5.803M28.11 147.273l1.704 7.304-13.015 3.036c-8.66 2.021-16.433-5.752-14.412-14.412l3.036-13.015 7.304 1.704-3.037 13.015c-.757 3.248 2.157 6.162 5.405 5.405zM14.204 125.56 6.9 123.856l1.772-7.593a79.4 79.4 0 0 1-6.406-17.279l7.286-1.78a72 72 0 0 0 5.803 15.655l1.243 2.441zM8.338 91.062.925 92.207A80.6 80.6 0 0 1 0 80c0-4.15.316-8.227.925-12.207l7.414 1.144A73 73 0 0 0 7.5 80c0 3.763.286 7.457.838 11.062M9.554 62.795l-7.288-1.78a79.5 79.5 0 0 1 9.35-22.554l6.41 3.895a72 72 0 0 0-8.472 20.439M21.51 37.153l-6.05-4.432A80.5 80.5 0 0 1 32.72 15.459l4.433 6.05A73 73 0 0 0 21.51 37.154M42.356 18.027l-3.894-6.412a79.5 79.5 0 0 1 22.554-9.349l1.78 7.288a72 72 0 0 0-20.44 8.473"
						/>
						<path
							d="M145 80c0 35.899-29.101 65-65 65-11.387 0-22.09-2.928-31.396-8.072a4.14 4.14 0 0 0-2.94-.426l-28.913 6.747 6.747-28.914a4.14 4.14 0 0 0-.426-2.939C17.928 102.089 15 91.386 15 80c0-35.898 29.102-65 65-65 35.899 0 65 29.102 65 65"
						/>
					</g>
				</svg>
				Signal</a
		...
		<h2>
			...
			>
				<svg
					...
					xml:space="preserve"
					class="icon"
					viewBox="-271 273 307.2 307.2"
				>
					<g fill="rgb(var(--text-color))" transform="translate(25.6,25.6)">
						<path
							d="M-271 360v48.9c31.9 0 62.1 12.6 84.7 35.2s35.1 52.8 35.1 84.8v.1h49.1c0-46.6-19-88.7-49.6-119.4-30.5-30.6-72.7-49.5-119.3-49.6M-237 460.9c-9.4 0-17.8 3.8-24 10s-10 14.6-10 24c0 9.3 3.8 17.7 10 23.9 6.2 6.1 14.6 9.9 24 9.9s17.8-3.7 24-9.9 10-14.6 10-23.9c0-9.4-3.8-17.8-10-24s-14.6-10-24-10"
						/>
						<path
							d="M-90.1 348.1c-46.3-46.4-110.2-75.1-180.8-75.1v48.9c114.1.1 206.8 93 206.9 207.1h49c0-70.6-28.7-134.5-75.1-180.9"
						/>
					</g>
				</svg>
			</a>
