...
<article class="narrow">
	...
	<p style="margin-top: 0.5ex;">
		i’m Lisa. (she/it/he) i’m a multidisciplinary artist from toronto. my work
	...
	<h3>
		...
		<a target="_blank" href="https://github.com/ncb-0" class="button"
			><svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 98 96">
				<path
					fill="rgb(var(--text-color))"
					fill-rule="evenodd"
